...
impl Action for BrowserArtistSongsAction {
    ...
    fn describe(&self) -> std::borrow::Cow<'_, str> {
        match &self {
            ...
            BrowserArtistSongsAction::AddSongToPlaylist => "Add song to queue",
            BrowserArtistSongsAction::AddSongsToPlaylist => "Add songs to queue",
            BrowserArtistSongsAction::AddAlbumToPlaylist => "Add album to queue",
