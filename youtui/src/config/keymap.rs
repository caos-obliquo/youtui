...
use crate::app::ui::browser::library::BrowserLibraryAction;
...
pub struct YoutuiKeymap {
    ...
    pub browser_library: BTreeMap<Keybind, KeyActionTree<AppAction>>,
...
pub struct YoutuiKeymapIR {
    ...
    pub browser_library: BTreeMap<Keybind, KeyStringTree>,
...
pub struct YoutuiModeNamesIR {
    ...
    browser_library: BTreeMap<Keybind, ModeNameEnum>,
...
impl Default for YoutuiKeymap {
    fn default() -> Self {
        Self {
            ...
            browser_library: default_browser_library_keybinds(),
...
impl YoutuiKeymap {
    pub fn try_from_stringy(keys: YoutuiKeymapIR, mode_names: YoutuiModeNamesIR) -> Result<Self> {
        ...
        let YoutuiModeNamesIR {
            ...
            browser_library: mut browser_library_mode_names,
        ...
        merge_keymaps(&mut keymap.browser_library, browser_library);
        ...
        remove_action_from_keymap(&mut keymap.browser_library, &AppAction::NoOp);
...
fn default_global_keybinds() -> BTreeMap<Keybind, KeyActionTree<AppAction>> {
    FromIterator::from_iter([
        ...
        (
            ...
            KeyActionTree::new_key_with_visibility(AppAction::Playlist(PlaylistAction::CopySongUrl), KeyActionVisibility::Global),
        ),
        (
            Keybind::new_unmodified(crossterm::event::KeyCode::Char('+')),
        ...
        (
            ...
            KeyActionTree::new_mode(
                [
                    ...
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('R')),
                        KeyActionTree::new_key(AppAction::Playlist(PlaylistAction::GetRelatedTracks)),
                    ),
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('S')),
                        KeyActionTree::new_key(AppAction::Playlist(PlaylistAction::SortQueue)),
                    ...
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('q')),
                        KeyActionTree::new_key(AppAction::Playlist(PlaylistAction::SaveQueue)),
                    ),
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('L')),
                        KeyActionTree::new_key(AppAction::Playlist(PlaylistAction::LoadQueue)),
                    ),
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('Q')),
...
fn default_browser_keybinds() -> BTreeMap<Keybind, KeyActionTree<AppAction>> {
    FromIterator::from_iter([
        ...
        (
            Keybind::new_unmodified(crossterm::event::KeyCode::F(1)),
            KeyActionTree::new_key(AppAction::Browser(BrowserAction::Search)),
        ),
        (
        ...
        (
            ...
            KeyActionTree::new_mode(
                [
                    ...
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('a')),
                        KeyActionTree::new_key(AppAction::BrowserSongs(BrowserSongsAction::GoToArtist)),
                    ),
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('b')),
                    ...
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('r')),
                        KeyActionTree::new_key(AppAction::BrowserSongs(BrowserSongsAction::GetRelatedTracks)),
                    ),
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('M')),
...
fn default_browser_playlists_keybinds() -> BTreeMap<Keybind, KeyActionTree<AppAction>> {
    FromIterator::from_iter([
        (
            Keybind::new_unmodified(crossterm::event::KeyCode::Enter),
            KeyActionTree::new_key(AppAction::BrowserPlaylists(BrowserPlaylistsAction::DisplaySelectedPlaylist)),
        ),
    ])
}
...
fn default_browser_artist_songs_keybinds() -> BTreeMap<Keybind, KeyActionTree<AppAction>> {
    FromIterator::from_iter([
            ...
            KeyActionTree::new_mode(
                [
                    ...
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('y')),
                        KeyActionTree::new_key(AppAction::BrowserArtistSongs(
                            BrowserArtistSongsAction::CopySongUrl,
                        )),
                    ),
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('l')),
        ...
        (
            Keybind::new_unmodified(crossterm::event::KeyCode::Enter),
            KeyActionTree::new_key(AppAction::BrowserArtistSongs(BrowserArtistSongsAction::PlaySong)),
        ),
        (
            Keybind::new_unmodified(crossterm::event::KeyCode::Char('g')),
            KeyActionTree::new_mode(
                [
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('a')),
                        KeyActionTree::new_key(AppAction::BrowserArtistSongs(BrowserArtistSongsAction::GoToArtist)),
                    ),
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('b')),
                        KeyActionTree::new_key(AppAction::BrowserArtistSongs(BrowserArtistSongsAction::GoToAlbum)),
                    ),
                ],
                "Go To".into(),
            ),
...
fn default_browser_playlist_songs_keybinds() -> BTreeMap<Keybind, KeyActionTree<AppAction>> {
    FromIterator::from_iter([
        (
            Keybind::new_unmodified(crossterm::event::KeyCode::Char('y')),
            KeyActionTree::new_key_with_visibility(
                AppAction::BrowserPlaylistSongs(BrowserPlaylistSongsAction::CopySongUrl),
                KeyActionVisibility::Global,
            ),
        ),
        (
            ...
            KeyActionTree::new_mode(
                [
                    ...
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('y')),
                        KeyActionTree::new_key(AppAction::BrowserPlaylistSongs(
                            BrowserPlaylistSongsAction::CopySongUrl,
                        )),
                    ),
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('a')),
                        KeyActionTree::new_key(AppAction::BrowserPlaylistSongs(
                            BrowserPlaylistSongsAction::GoToArtist,
                        )),
                    ),
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('b')),
                        KeyActionTree::new_key(AppAction::BrowserPlaylistSongs(
                            BrowserPlaylistSongsAction::GoToAlbum,
                        )),
                    ),
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('l')),
                        KeyActionTree::new_key(AppAction::BrowserPlaylistSongs(
                            BrowserPlaylistSongsAction::ViewLyrics,
                        )),
                    ),
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('r')),
        ...
        (
            Keybind::new_unmodified(crossterm::event::KeyCode::Enter),
            KeyActionTree::new_key(AppAction::BrowserPlaylistSongs(BrowserPlaylistSongsAction::PlaySong)),
        ),
        (
            Keybind::new_unmodified(crossterm::event::KeyCode::Char('g')),
            KeyActionTree::new_mode(
                [
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('a')),
                        KeyActionTree::new_key(AppAction::BrowserPlaylistSongs(BrowserPlaylistSongsAction::GoToArtist)),
                    ),
                    (
                        Keybind::new_unmodified(crossterm::event::KeyCode::Char('b')),
                        KeyActionTree::new_key(AppAction::BrowserPlaylistSongs(BrowserPlaylistSongsAction::GoToAlbum)),
                    ),
                ],
                "Go To".into(),
            ),
...
fn default_sort_keybinds() -> BTreeMap<Keybind, KeyActionTree<AppAction>> {
    FromIterator::from_iter([
        ...
        (
            Keybind::new(crossterm::event::KeyCode::Char('4'), KeyModifiers::ALT),
            KeyActionTree::new_key_with_visibility(
...
fn default_filter_keybinds() -> BTreeMap<Keybind, KeyActionTree<AppAction>> {
    FromIterator::from_iter([
        ...
        (
            Keybind::new(crossterm::event::KeyCode::Char('3'), KeyModifiers::ALT),
            KeyActionTree::new_key_with_visibility(
...
fn default_list_keybinds() -> BTreeMap<Keybind, KeyActionTree<AppAction>> {
    FromIterator::from_iter([
        ...
        (
            Keybind::new(crossterm::event::KeyCode::Char('b'), KeyModifiers::CONTROL),
            KeyActionTree::new_key(AppAction::List(ListAction::PageUp)),
        ),
        (
            Keybind::new(crossterm::event::KeyCode::Char('u'), KeyModifiers::CONTROL),
